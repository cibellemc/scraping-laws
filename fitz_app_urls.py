...
def processar_pdf(url):
    try:
        nome_arquivo = f"pdfs/{url.split('/')[-1]}"
...
with open("documentos_url_fitz.json", "w", encoding="utf-8") as f:
    json.dump(documentos, f, ensure_ascii=False, indent=4)

print("✅ Processo concluído! Arquivo 'documentos_url_fitz.json' gerado.")
